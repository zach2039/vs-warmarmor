...
This mod adds warmth to some armor pieces. This is now a content-only mod with v2.0.0, with the VS-1.21.x addition of the `warmth` attribute.

Note, for armors with warmth, their condition will affect warmth given.
